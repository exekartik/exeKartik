...
Won Bronze Medal — 10th Design, Manufacturing, and Application Award 2022.`,
  ...
  {
    year: 2025,
    content: `Open-sourced [exeKartik](https://github.com/exekartik/exeKartik) — 2k+ stars on GitHub.

Released [React Wheel Picker](https://github.com/exekartik/exeKartik) — 50k+ weekly downloads, selected for the [Vercel OSS Program](https://vercel.com/open-source-program).
