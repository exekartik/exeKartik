          ...
          <div className="mr-2 ml-6 flex size-6 shrink-0 items-center justify-center text-muted-foreground group-hover/project:text-foreground">
            {project.id === "doctors-vision" && (
              <svg className="size-4" viewBox="0 0 24 24" fill="currentColor">
                <path d="M19.5 4A2.5 2.5 0 1 0 17 6.5V8a6 6 0 0 1-4 5.66V20a2 2 0 1 1-4 0v-6.34A6 6 0 0 1 5 8V6.5A2.5 2.5 0 1 0 4.5 4A2.5 2.5 0 0 0 2 6.5V8a8 8 0 0 0 7 7.93V20a4 4 0 1 0 8 0v-4.07A8 8 0 0 0 24 8V6.5A2.5 2.5 0 0 0 19.5 4ZM7 18a3 3 0 1 0-6 0 3 3 0 0 0 6 0Zm-2 0a1 1 0 1 1 2 0 1 1 0 0 1-2 0Z" />
              </svg>
            )}
